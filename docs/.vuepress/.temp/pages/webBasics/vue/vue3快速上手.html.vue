<template><div><p><a name="956552a8"></a></p>
<h1 id="vue3快速上手" tabindex="-1"><a class="header-anchor" href="#vue3快速上手" aria-hidden="true">#</a> Vue3快速上手</h1>
<p><img src="https://user-images.githubusercontent.com/499550/93624428-53932780-f9ae-11ea-8d16-af949e16a09f.png#" alt=""></p>
<p><a name="46c4081b"></a></p>
...
<p>重写虚拟DOM的实现和Tree-Shaking
<br />......</p>
<p><a name="aed39640"></a></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="2ab7faab"></a></p>
<h2 id="_2-使用-vite-创建" tabindex="-1"><a class="header-anchor" href="#_2-使用-vite-创建" aria-hidden="true">#</a> 2.使用 vite 创建</h2>
...
<li>
<p>传统构建 与 vite构建对比图</p>
</li>
</ul>
<p><img src="https://cn.vitejs.dev/assets/bundler.37740380.png#" alt=""><img src="https://cn.vitejs.dev/assets/esm.3070012d.png#" alt=""></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="1dd8e989"></a></p>
<h1 id="二、常用-composition-api" tabindex="-1"><a class="header-anchor" href="#二、常用-composition-api" aria-hidden="true">#</a> 二、常用 Composition API</h1>
...
<li>
<p>setup是所有<strong>Composition API（组合API）</strong>“ 表演的舞台 ”。</p>
</li>
<li>
...
<li>
<p>语法: <code v-pre>const xxx = ref(initValue)</code></p>
<ul>
<li>创建一个包含响应式数据的<strong>引用对象（reference对象，简称ref对象）</strong>。</li>
<li>JS中操作数据： <code v-pre>xxx.value</code></li>
<li>模板中读取数据: 不需要.value，直接：<code v-pre>&lt;div&gt;{{xxx}}&lt;/div&gt;</code></li>
</ul>
</li>
<li>
<p>备注：</p>
...
<li>对象类型的数据：内部 “ 求助 ” 了Vue3.0中的一个新函数—— <code v-pre>reactive</code>函数。</li>
</ul>
</li>
</ul>
<p><a name="4d996a47"></a></p>
<h2 id="_3-reactive函数" tabindex="-1"><a class="header-anchor" href="#_3-reactive函数" aria-hidden="true">#</a> 3.reactive函数</h2>
<ul>
<li>作用: 定义一个<strong>对象类型</strong>的响应式数据（基本类型不要用它，要用<code v-pre>ref</code>函数）</li>
<li>语法：<code v-pre>const 代理对象= reactive(源对象)</code>接收一个对象（或数组），返回一个<strong>代理对象（Proxy的实例对象，简称proxy对象）</strong></li>
<li>reactive定义的响应式数据是“深层次的”。</li>
<li>内部基于 ES6 的 Proxy 实现，通过代理对象操作源对象内部数据进行操作。</li>
</ul>
<p><a name="8faee4ba"></a></p>
<h2 id="_4-vue3-0中的响应式原理" tabindex="-1"><a class="header-anchor" href="#_4-vue3-0中的响应式原理" aria-hidden="true">#</a> 4.Vue3.0中的响应式原理</h2>
<p><a name="b705749f"></a></p>
...
<li>备注：ref也可以用来定义<strong>对象（或数组）类型数据</strong>, 它内部会自动通过<code v-pre>reactive</code>转为<strong>代理对象</strong>。</li>
</ul>
</li>
<li>
<p>从原理角度对比：</p>
...
<p>从使用角度对比：</p>
<ul>
<li>ref定义的数据：操作数据<strong>需要</strong><code v-pre>.value</code>，读取数据时模板中直接读取<strong>不需要</strong><code v-pre>.value</code>。</li>
<li>reactive定义的数据：操作数据与读取数据：<strong>均不需要</strong><code v-pre>.value</code>。</li>
</ul>
</li>
</ul>
<p><a name="ce921510"></a></p>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="c36c8f03"></a></p>
<h2 id="_8-生命周期" tabindex="-1"><a class="header-anchor" href="#_8-生命周期" aria-hidden="true">#</a> 8.生命周期</h2>
<p><strong>vue2.x的生命周期</strong><img src="https://cn.vuejs.org/images/lifecycle.png#alt=lifecycle_2" alt=""><strong>vue3.0的生命周期</strong><img src="https://v3.cn.vuejs.org/images/lifecycle.svg#alt=lifecycle_2" alt="">
1</p>
<ul>
<li>
...
<p>扩展：<code v-pre>toRefs</code> 与<code v-pre>toRef</code>功能一致，但可以批量创建多个 ref 对象，语法：<code v-pre>toRefs(person)</code></p>
<p><a name="5130b254"></a></p>
...
<p>toRaw：</p>
<ul>
<li>作用：将一个由<code v-pre>reactive</code>生成的<strong>响应式对象</strong>转为<strong>普通对象</strong>。</li>
...
<p><img src="https://v3.cn.vuejs.org/images/components_provide.png#" alt=""></p>
<ul>
<li></li>
</ul>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token function">setup</span><span class="token punctuation">(</span><span class="token parameter">props<span class="token punctuation">,</span>context</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
	...
	<span class="token operator">...</span><span class="token operator">...</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="09c12199"></a></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f84e4e2c02424d9a99862ade0a2e4114~tplv-k3u1fbpfcp-watermark.image#" alt="">
<img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e5ac7e20d1784887a826f6360768a368~tplv-k3u1fbpfcp-watermark.image#" alt="">
<a name="e76f35ec"></a></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bc0be8211fc54b6c941c036791ba4efe~tplv-k3u1fbpfcp-watermark.image#" alt="">
<img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6cc55165c0e34069a75fe36f8712eb80~tplv-k3u1fbpfcp-watermark.image#" alt="">
<a name="fd46eec1"></a></p>
<h1 id="五、新的组件" tabindex="-1"><a class="header-anchor" href="#五、新的组件" aria-hidden="true">#</a> 五、新的组件</h1>
<p><a name="1.Fragment"></a></p>
...
<p><a name="2.Teleport"></a></p>
<h2 id="_2-teleport" tabindex="-1"><a class="header-anchor" href="#_2-teleport" aria-hidden="true">#</a> 2.Teleport</h2>
<ul>
<li></li>
</ul>
<p>什么是Teleport？—— <code v-pre>Teleport</code> 是一种能够将我们的<strong>组件html结构</strong>移动到指定位置的技术。</p>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>teleport</span> <span class="token attr-name">to</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>移动位置<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="3.Suspense"></a></p>
...
<p>异步引入组件</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span>defineAsyncComponent<span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'vue'</span>
...
<p>将全局的API，即：<code v-pre>Vue.xxx</code>调整到应用实例（<code v-pre>app</code>）上</p>
<table>
<thead>
<tr>
...
<p><strong>移除</strong>keyCode作为 v-on 的修饰符，同时也不再支持<code v-pre>config.keyCodes</code></p>
<ul>
<li></li>
</ul>
...
<p>父组件中绑定事件</p>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>my-component</span>
